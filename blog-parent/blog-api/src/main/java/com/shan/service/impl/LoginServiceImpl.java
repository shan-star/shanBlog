...
import com.shan.utils.JWTUtils;
...
public class LoginServiceImpl implements LoginService {
    ...
    //盐值
    private static final String slat = "shan!@yes";
     ...
     * 3．进行缓存，token放入redis当中
     * key是token，value是user信息，并且设置过期时间
...
//            return Result.fail(ErrorCode.TOKEN_ERROR.getCode(), ErrorCode.TOKEN_ERROR.getMsg());
        ...
        //获取redis缓存的用户，判断redis缓存是否为空(可能过期)
