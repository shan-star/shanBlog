<template>
  <div class="head-photo" style="width: 100%;height: 800px">
    ...
    <img src="https://niu.yilele.site/189e57fb-53af-46b8-a27f-9a4cdc9a3fbe.jpeg" style="width: 100%;height: 100%">
    ...
    <el-row style="height: 95vh">
      <el-col :span="24" style="height: 100%">
        <el-card shadow="none" class="welcome">
          ...
          <div id="waypoint" class="mini-nav">

            <span class="item" @click="startRead">
              首页
            </span>
            <span  class="item" @click="startRead">
              后台系统
            </span>
            <span class="item" @click="aboutMe">
              关于我
            </span>
          </div>
